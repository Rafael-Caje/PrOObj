...
import HistoricoRafa from "../Historico/HistoricoCliente/historicoRafa";
import HistoricoFabia from "../Historico/HistoricoCliente/historicoFabia";
...
export default function ListaCliente() {
  ...
  function historico() {
    if (nome === "Rafa") {
      return <HistoricoRafa tema="#ff4081 pink accent-2" />;
    } else if (nome === "Fabia") {
      return <HistoricoFabia tema="#ff4081 pink accent-2" />;
    }
  }
        ...
        <ul className="collapsible">
          <li>
            ...
            <div id="collapsibleBody" className="collapsible-body">
              ...
              <span>Sexo: O</span>
              <br />
              <span>Data de Nascimento: 28/10/1999</span>
              <br />
              <span>CPF: 12389314478</span>
              <br />
              <span>E-mail: francisco@francisco.com</span>
              <br />
              <span>DDD: 12</span>
              <br />
              <span>Telefone: 129489384</span>
              <br />
              <span>Endereço: </span>
              <br />
          ...
          <li>
            ...
            <div id="collapsibleBody" className="collapsible-body">
              ...
              <span>Sexo: M</span>
              <br />
              <span>Data de Nascimento: 26/01/1983</span>
              <br />
              <span>CPF: 1239122152</span>
              <br />
              <span>E-mail: rafa@rafa.com</span>
              <br />
              <span>DDD: 12</span>
              <br />
              <span>Telefone: 988379493</span>
              <br />
              <span>Endereço: </span>
              <br />
              ...
              <span>12345678 </span>
              <br />
              <span>R. Rosa de Toledo, 322 </span>
              <br />
              <span>76B</span>
              <br />
          ...
          <li>
            ...
            <div id="collapsibleBody" className="collapsible-body">
              <span>Nome Social: Faby</span>
              <br />
              <span>Sexo: F</span>
              <br />
              <span>Data de Nascimento: 03/03/1999</span>
              <br />
              <span>CPF: 12345678912</span>
              <br />
              <span>E-mail: fabia@fabia.com</span>
              <br />
              <span>DDD: 12</span>
              <br />
              ...
              <br />
              <span>12 98888888 </span>
              <br />
              <span>R. 7 de Setembro, 1200 </span>
              <br />
              <span>Sem Complemento</span>
              <br />
